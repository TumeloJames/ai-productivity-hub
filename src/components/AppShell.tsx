...
export function ResponsibleAiNote({ className }: { className?: string }) {
  return (
    <p className={cn("text-xs leading-relaxed text-sidebar-foreground/55", className)}>
    ...
    <div className="flex h-full flex-col gap-6 p-5">
      <Link to="/" onClick={onNavigate} className="flex items-center gap-3">
        ...
        <span className="text-sm leading-tight font-semibold text-sidebar-foreground">
          Workplace
          <span className="block text-xs font-normal text-sidebar-foreground/55">AI Assistant</span>
        </span>
      </Link>
